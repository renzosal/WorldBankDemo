...
(function () {
  ...
  angular.module('worldBank').constant('CONFIG', config).constant('TOPICS', topics).config(configuration);
...
(function () {
  'use strict';
  angular.module('worldBank').constant('routes', getRoutes()).config(routeConfiguration);
...
(function () {
  'use strict';
  angular.module('worldBank').factory('WorldBankService', worldBankService);
  worldBankService.$inject = [
    '$http',
    '$q',
    'CONFIG'
  ];
  function worldBankService($http, $q, CONFIG) {
    ...
    function _getTopicDescription(topicId) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'topic/' + topicId, { params: { per_page: 260 } }).then(function (response) {
          var topicData = {
    ...
    function _getCountries() {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + '/countries/all', { params: { per_page: 262 } }).then(function (response) {
          var countryList = [];
...
(function () {
  'use strict';
  angular.module('worldBank').factory('httpInterceptor', httpInterceptor);
 ...
 */
  angular.module('worldBank').directive('mapDateSelector', mapdateselector);
  ...
  function mapdateselector() {
    var directive = {
        ...
        template: '<ul class="nav nav-tabs">' + '<li ng-class="{active: ngModel == year}" ' + 'ng-click="setModel(year)" ng-repeat="year in years">' + '<a>{{year}}</a></li></ul>',
        link: link
      };
    return directive;
 ...
 */
  angular.module('worldBank').directive('autocomplete', autocomplete);
      ...
      element.on('input', function () {
        ...
        if (ngModel.$viewValue.length > 2) {
          scope.filteredArr = _.filter(sourceArr, function (country) {
            return country.name.toLowerCase().indexOf(ngModel.$viewValue.toLowerCase()) > -1;
          });
        } else {
          scope.filteredArr = [];
        }
  ...
  angular.module('worldBank').directive('disableAnimation', disableAnimation);
  ...
  angular.module('worldBank').directive('canvasChart', canvasChart);
  ...
  angular.module('worldBank').directive('jqvmap', jqvmap);
  ...
  angular.module('worldBank').directive('slideOut', slideOut);
  function slideOut() {
    return {
      restrict: 'A',
      scope: { show: '=slideOut' },
  ...
  angular.module('worldBank').directive('pulsate', pulsate);
  function pulsate() {
    return {
      scope: { pulsate: '=' },
      link: function (scope, element, attr) {
  ...
  angular.module('worldBank').directive('stickyScroll', stickyScroll);
  ...
  angular.module('worldBank').directive('backToTop', backToTop);
  function backToTop() {
    return {
      restrict: 'AE',
      link: function (scope, element, attr) {
...
(function () {
  'use strict';
  angular.module('worldBank').factory('EnquireService', enquireService);
  enquireService.$inject = ['$window'];
  function enquireService($window) {
    return $window.enquire;
  }
  angular.module('worldBank').service('globalService', globalService);
...
(function () {
  angular.module('worldBank').controller('ShellController', ShellController);
...
(function () {
  'use strict';
  angular.module('worldBank').controller('NavigationController', navigationController);
  ...
  function navigationController($location, $timeout, $scope) {
    ...
    function _findItemByUrl(menu, url) {
      for (var i = 0, length = menu.length; i < length; i++) {
        if (menu[i].url && menu[i].url.replace('#', '') == url)
          return menu[i];
      }
    }
    ;
...
(function () {
  'use strict';
  angular.module('worldBank').controller('DashboardController', dashboardController);
  ...
  function dashboardController(countries, DashboardHelper, worldEconomy, worldEducation, worldHealth, worldEnvironment, worldUrbanDev) {
    var vm = this;
...
(function () {
  'use strict';
  angular.module('worldBank').factory('DasboardResolver', dashboardResolver);
  dashboardResolver.$inject = [
    '$q',
    'WorldBankService',
    'EconomyService',
    'EducationService',
  ...
  function dashboardResolver($q, WorldBankService, EconomyService, EducationService, HealthService, EnvironmentService, UrbanService) {
    var data = {
    ...
    function _getAllCountries() {
      return WorldBankService.getCountries().then(function (data) {
        return data;
      });
    }
    function _worldEconomy() {
      return EconomyService.getAllGDP(2012, '1W').then(function (data) {
        return data;
      });
    }
    function _worldEducation() {
      return EducationService.getAllSchoolEnrollPrimaryByYear(2012, '1W').then(function (data) {
        return data;
      });
    }
    function _worldHealth() {
      return HealthService.getAllLifeExpectancyByYear(2012, '1W').then(function (data) {
        return data;
      });
    }
    function _worldEnvironment() {
      return EnvironmentService.getAllEnergyUseKtByYear(2012, '1W').then(function (data) {
        return data;
      });
    }
    function _worldUrbanDev() {
      return UrbanService.getAllUrbanPopPercentageByYear(2012, '1W').then(function (data) {
        return data;
      });
    }
  }
...
(function () {
  'use strict';
  angular.module('worldBank').factory('DashboardHelper', dashboardHelper);
  dashboardHelper.$inject = [
    '$q',
    'EducationService',
    'EconomyService',
    'HealthService',
...
(function () {
  'use strict';
  angular.module('worldBank').controller('HealthController', healthController);
  ...
  function healthController(HealthHelper, lifeExpectancy, topicInfo) {
    ...
    function _getIndicatorData(methodName) {
      ...
      vm.mapHoverLabelFormat = _.find(vm.indicators, function (ind) {
        return ind.method === methodName;
      }).labelFormat;
...
(function () {
  'use strict';
  angular.module('worldBank').factory('HealthResolver', healthResolver);
  healthResolver.$inject = [
    '$q',
    'WorldBankService',
    'HealthService',
    'TOPICS'
  ...
  function healthResolver($q, WorldBankService, HealthService, TOPICS) {
    ...
    function _lifeExpectancy() {
      return HealthService.getAllLifeExpectancyByYear(2012).then(function (data) {
        return data;
      });
    }
    function _topicInfo() {
      return WorldBankService.getTopicDescription(TOPICS.Health).then(function (data) {
        return data;
      });
    }
  }
...
(function () {
  'use strict';
  angular.module('worldBank').factory('HealthService', healthService);
  ...
  function healthService($http, $q, CONFIG) {
    ...
    function _getAllHealthExpenditureByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/SH.XPD.PCAP', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllFertilityRateByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/SP.DYN.TFRT.IN', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllLifeExpectancyByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/SP.DYN.LE00.IN', {
          params: {
            per_page: 260,
            date: year
          }
...
(function () {
  'use strict';
  angular.module('worldBank').controller('EconomyController', economyController);
  economyController.$inject = [
    'EconomyHelper',
    'GNPPerCapita',
    'GNPPerCapitaWorld',
    'topicInfo'
...
(function () {
  'use strict';
  angular.module('worldBank').factory('EconomyResolver', economyResolver);
  economyResolver.$inject = [
    '$q',
    'WorldBankService',
    'EconomyService',
    'TOPICS'
  ...
  function economyResolver($q, WorldBankService, EconomyService, TOPICS) {
    ...
    function _GNPPerCapita() {
      return EconomyService.getAllGNIPerCapitaByYear(2013).then(function (data) {
        return data;
      });
    }
    function _GNPPerCapitaWorld() {
      console.log('test');
      return EconomyService.getAllGNIPerCapitaByYear('2003:2013', '1W').then(function (data) {
        return data;
      });
    }
    function _topicInfo() {
      return WorldBankService.getTopicDescription(TOPICS.Economy).then(function (data) {
        return data;
      });
    }
  }
...
(function () {
  'use strict';
  angular.module('worldBank').factory('EconomyService', economyService);
  economyService.$inject = [
    '$http',
    '$q',
    'CONFIG'
  ];
  function economyService($http, $q, CONFIG) {
    ...
    function _getAllGDP(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/NY.GDP.MKTP.CD', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllTotalReserves(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/FI.RES.TOTL.CD', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllGNIPerCapitaByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/NY.GNP.PCAP.CD', {
          params: {
            per_page: 260,
            date: year
          }
...
(function () {
  'use strict';
  angular.module('worldBank').controller('EducationController', educationController);
...
(function () {
  'use strict';
  angular.module('worldBank').factory('EducationResolver', educationResolver);
  educationResolver.$inject = [
    '$q',
    'WorldBankService',
    'EducationService',
    'TOPICS'
  ...
  function educationResolver($q, WorldBankService, EducationService, TOPICS) {
    ...
    function _SchoolEnrollmentPrimary() {
      return EducationService.getAllSchoolEnrollPrimaryByYear(2011).then(function (data) {
        return data;
      });
    }
    function _topicInfo() {
      return WorldBankService.getTopicDescription(TOPICS.Education).then(function (data) {
        return data;
      });
    }
  }
...
(function () {
  'use strict';
  angular.module('worldBank').factory('EducationService', educationService);
  ...
  function educationService($http, $q, CONFIG) {
    ...
    function _getAllOutOfSchoolMaleByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/SE.PRM.UNER.MA', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllOutOfSchoolFemaleByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/SE.PRM.UNER.FE', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllPupilTeacherRatioPrimaryByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/SE.PRM.ENRL.TC.ZS', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllSchoolEnrollSecondaryByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/SE.SEC.ENRR', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllSchoolEnrollPrimaryByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/SE.PRM.ENRR', {
          params: {
            per_page: 260,
            date: year
          }
...
(function () {
  'use strict';
  angular.module('worldBank').controller('EnvironmentController', environmentController);
...
(function () {
  'use strict';
  angular.module('worldBank').factory('EnvironmentResolver', environmentResolver);
  environmentResolver.$inject = [
    '$q',
    'WorldBankService',
    'EnvironmentService',
    'TOPICS'
  ...
  function environmentResolver($q, WorldBankService, EnvironmentService, TOPICS) {
    ...
    function _EnergyUseKt() {
      return EnvironmentService.getAllEnergyUseKtByYear(2011).then(function (data) {
        return data;
      });
    }
    function _topicInfo() {
      return WorldBankService.getTopicDescription(TOPICS.Environment).then(function (data) {
        return data;
      });
    }
  }
...
(function () {
  'use strict';
  angular.module('worldBank').factory('EnvironmentService', environmentService);
  ...
  function environmentService($http, $q, CONFIG) {
    ...
    function _getAllEnergyProdKtByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/EG.EGY.PROD.KT.OE', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllEnergyUseKtByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/EG.USE.COMM.KT.OE', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllAccessElectricityByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/EG.ELC.ACCS.ZS', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllForestAreaKmByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/AG.LND.FRST.K2', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllCO2perCapitaByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/EN.ATM.CO2E.PC', {
          params: {
            per_page: 260,
            date: year
          }
...
(function () {
  'use strict';
  angular.module('worldBank').controller('UrbanController', urbanController);
  urbanController.$inject = [
    'UrbanHelper',
    'urbanPopulation',
    'topicInfo'
  ];
...
(function () {
  'use strict';
  angular.module('worldBank').factory('UrbanResolver', urbanResolver);
  urbanResolver.$inject = [
    '$q',
    'WorldBankService',
    'UrbanService',
    'TOPICS'
  ...
  function urbanResolver($q, WorldBankService, UrbanService, TOPICS) {
    ...
    function _urbanPopulation() {
      return UrbanService.getAllUrbanPopPercentageByYear(2013).then(function (data) {
        return data;
      });
    }
    function _topicInfo() {
      return WorldBankService.getTopicDescription(TOPICS.Urban).then(function (data) {
        return data;
      });
    }
  }
...
(function () {
  'use strict';
  angular.module('worldBank').factory('UrbanService', urbanService);
  urbanService.$inject = [
    '$http',
    '$q',
    'CONFIG'
  ...
  function urbanService($http, $q, CONFIG) {
    ...
    function _getAllWaterAccessByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/SH.H2O.SAFE.UR.ZS', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllSanitationAccessByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/SH.STA.ACSN.UR', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllLargestCityPopByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/EN.URB.LCTY.UR.ZS', {
          params: {
            per_page: 260,
            date: year
          }
    ...
    function _getAllUrbanPopPercentageByYear(year) {
      var promise = $http.jsonp(CONFIG.apiBaseUrl + 'countries/' + _getCountryCode(arguments) + '/indicators/SP.URB.TOTL.IN.ZS', {
          params: {
            per_page: 260,
            date: year
          }
